...
extern "C" void kernelMain(void* multiboot_structure, uint32_t magicnumber)
{
  ...
  printf("\n[Note] Hey, I've got a job for you! Before you do anything, take a picture of this screen. I need to get a list of all of the hex values for the keys you're hitting. Let me know what each key returns!");
  // Aaahhh... Missed a semicolon again... >_<
