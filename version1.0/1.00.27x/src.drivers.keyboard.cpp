    ...
    static bool Shift = false;
        ...
        switch(key)
        {
            ...
            case 0x40:
            {
                ...
                printf("                                                                                ");
                printf("  --- ---      System  : NanamiOS         Version : 1.00.27x                    ");
                printf(" -   -   -     DevStage: Alpha            BuldDate: 2023-11-16                  ");
                printf("  -     -      Drivers : 2                Publishr: SteelsOfLiquid              ");
