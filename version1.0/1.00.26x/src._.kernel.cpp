...
extern "C" void kernelMain(void* multiboot_structure, uint32_t magicnumber)
{
  ...
  // printf("SteelsOfLiquid NanamiOS [NanamiMadobe OS Version 1.00.26 Codename \"Reimu\" Alpha]\n");
  ...
  // printf("[Now Online] NanamiOS Drivers\n");
  ...
  // printf("[Now Online] NanamiOS Interrupts\n");
...
*/
  ...
  printf(" _[Starting_Up...]_____________________________________________________________ ");
  printf("/                                                                              \\");
  printf("                 -           -            ----                                  ");
  printf("                ---  --     ---  --          -          --   --                 ");
  printf("                 -     -     -     -      ----  -      -  - -                   ");
  ...
  printf("                                                                                ");
  printf("                                                                                ");
  printf("                                               -       --- ---       -          "); // Use Visual Studio Code for this boot screen. The ASCII art doesn't render right in some programs, such as Notepad++.
  printf("      -- SteelsOfLiquid's NanamiOS! --        -       -   -   -       -         ");
  printf("           Version 1.00, Build 26            -         -     -         -        ");
  printf("                                             -      -   -   -   -      -        ");
  printf("    Codename: Reimu  |  Date: 2023/11/07    -      -     - -     -      -       ");
  printf("                                            -     -   -   -   -   -     -       ");  // Reminds me of Wii channels!
  printf("      Strike F4 key for help options!!      -     -  -    .    -  -     -       ");
  printf("                                             -    -   -       -   -    -        ");
  printf("                                             -     -   --   --   -     -        ");
  printf("                                              -     -    ---    -     -         ");
