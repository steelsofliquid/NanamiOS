...
extern "C" void kernelMain(void* multiboot_structure, uint32_t magicnumber)
{
  ...
  printf("                ----- NanamiOS 1.00.20[Codename \"Reimu\"] -----                ");
  printf(" Platform     Version    Kernel     Build Date          |       Genuine      / |");
  printf(" NanamiOS     1.00.20    S-PHXKS    2023 Nov. 1         | copy of NanamiOS  v  |");
  ...
  printf(" Created by SteelsOfLiquid <3                    -- Press any key to dismiss --");
  ...
  DriverManager drvManager;
    ...
    KeyboardDriver keyboard(&interrupts); // Oopsies! I forgot a semicolon! >_< (a bit back)
    drvManager.AddDriver(&keyboard);

    MouseDriver mouse(&interrupts); // drivers loading
